...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(5 to 10, optimizeBuyAndSell("input/bysell_in4.txt"))
        try {
    ...
    fun josephTask(josephTask: (Int, Int) -> Int) {
        ...
        assertEquals(1, josephTask(16,4))
        var menNumber = 2
        for (i in 1..20) {
...
Еще старушка не забыла
    ...
    fun baldaSearcher(baldaSearcher: (String, Set<String>) -> Set<String>) {
        ...
        assertEquals(setOf("ВОДА", "ВЕНОМ", "НОМЕР","ВОДОМЕР"), baldaSearcher("input/balda_in2.txt", setOf("ВОДА", "ВЕНОМ", "НОМЕР","ВОДОМЕР")))
    }
}